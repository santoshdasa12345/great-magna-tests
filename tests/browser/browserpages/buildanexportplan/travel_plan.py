...
SELECTORS = {
    "travel plan": {
        ...
        "languages educational": Selector(
            By.XPATH,
            '//*[@id="stats-for-target-market"]/div[1]/div/div/div/div/div/div/button/i'
        ...
        "i dont need visa": Selector(
            By.XPATH,
            "//body/main/div[2]/section[5]/div/div[2]/div[2]/div/div[1]/div[1]/label"
            # //*[@id=\"need-visa-false\"]"#//body/main/div[2]/section[5]/div/div[2]/div[2]/div/div[1]/label"
        ),
        "i need a visa": Selector(
            By.XPATH,
            "//body/main/div[2]/section[5]/div/div[2]/div[2]/div/div[1]/div[2]/label",
        ),
        "planned travel educational": Selector(
            By.XPATH,
            '//*[@id="planned-travel"]/div/div[1]/div/div/button/i',
        ...
        "how and where": Selector(By.CSS_SELECTOR, "#how_where_visa"),
        "how long": Selector(By.CSS_SELECTOR, "#how_long"),
        "notes": Selector(By.CSS_SELECTOR, "#notes"),
        "yes checkbox": Selector(
            By.CSS_SELECTOR,
            "#section-complete > div",  # //input[@id='checkbox_complete']"
        ),
        ...
        "open navigation": Selector(By.XPATH, '//*[@id="collapseNav"]/div/button/i'),
...
def enter_trip_details(driver: WebDriver, position: str, trip_name: str):
    ...
    document_div_element_xpath = (
        "//body/main/div[2]/section[6]/div/div[2]/div/div[2]/div" + "[" + position + "]"
    )
...
def delete_all_trip_details(driver: WebDriver, del_button_position: str):
    ...
    trip_text_area_element_x_path = (
        "//body/main/div[2]/section[6]/div/div[2]/div/div[2]/div"
        + "["
        + str(trip_text_area_element_index)
        + "]"
        + "/div[2]/button"
    )
    trip_text_area_text_exists = True
    try:
        trip_text_area_text = driver.find_element_by_xpath(
            trip_text_area_element_x_path
        ).text
    ...
    if trip_text_area_text_exists == True:
        ...
        delete_message_yes_element_xpath = (
            ...
            + "]"
            + "/div/div/div/div[2]/div[2]/button[1]/i"
        )
...
def select_radio_button(driver: WebDriver, element_name: str):
    ...
    driver.find_element_by_xpath(
        "//body[1]/main[1]/div[2]/section[5]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/input[1]"
    )  # //body/main/div[2]/section[5]/div/div[2]/div[2]/div/h2")
