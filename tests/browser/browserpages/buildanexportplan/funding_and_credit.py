...
SELECTORS = {
    "funding and credit": {
        ...
        "lesson": Selector(
            By.CSS_SELECTOR,
            "#finance-funding-credit-options > div.learning > div.learning__buttons > button",
        ),
        "avoid cashflow lesson": Selector(
            By.XPATH,
            "//body/main/div[2]/div/div/div[2]/div/div[2]/div/div[1]/div[1]/button",
        ),
        "add a funding option": Selector(
            By.XPATH, "//body/main/div[2]/div/div/div[2]/div/div[3]/div[2]/div/button"
        ),
        "select option": Selector(By.XPATH, "//tbody/tr[1]/td[1]/div[1]/button[1]"),
        "credit option": Selector(
            By.XPATH, "//input[@id='21']", type=ElementType.INPUT
        ),
        "delete": Selector(By.XPATH, "//tbody/tr[2]/td[1]/button[1]/i[1]"),
        "section complete": Selector(
            By.XPATH, "//body/main/div/div[2]/div[2]/div/div/div[2]/fieldset/div/div"
        ),
        "getting paid": Selector(By.XPATH, "//span[contains(text(),'Getting paid')]"),
        ...
        "avoid cashflow challenges when exporting": Selector(
            By.CSS_SELECTOR,
            "#finance-how-much-funding > div > div.learning > div.learning__content > a > div",
        ),
        ...
        "top export plan home": Selector(
            By.XPATH,
            '//*[@id="funding-and-credit-content"]/section[1]/div/div/div[2]/span/a',
        ),
...
def find_and_select_random_funding_options(
    driver: WebDriver, position: str, amount: str
):
    ...
    funding_option_element_xpath = (
        "//body/main/div[2]/div/div/div[2]/div/div[3]/div[2]/div"
        + "["
        + str(actual_positon)
        + "]"
    )
    funding_option_1_element = (
        funding_option_element_xpath + "/div/div[1]/div/div/div[2]"
    )  # /td[1]/div/div/div[2]/button"
    ...
    ulist_funding_options_xpath = (
        "//body/main/div[2]/div/div/div[2]/div/div[3]/div[2]/div"
        + "["
        + str(actual_positon)
        + "]"
    )
    ulist_funding_options_element = (
        ulist_funding_options_xpath + "/div/div[1]/div/div/div[2]/div[4]/ul"
    )
    ...
    funding_options_elements = ulist_funding_options_element.find_elements_by_tag_name(
        "li"
    )
    ...
    random_li_element = driver.find_element_by_xpath(
        ulist_funding_options_xpath + "/li[" + str(random_number) + "]"
    )
    random_li_element.click()
    time.sleep(2)
    ...
    gbp_text_elem_xpath = (
        gbp_elem_xpath + "/div/div[2]/div/div[2]/input"
    )  # /td[2]/div/div[2]/input"
...
def delete_all_funding_options(driver: WebDriver, del_button_position: str):
    ...
    funding_options_div_element_xpath = (
        "//body/main/div[2]/div/div/div[2]/div/div[3]/div[2]/div"
        + "["
        + del_button_position
        + "]"
