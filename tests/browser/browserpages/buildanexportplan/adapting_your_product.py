...
SELECTORS = {
    "adapting your Product": {
        ...
        "labelling educational": Selector(
            By.XPATH,
            '//*[@id="changes-to-product"]/div[2]/div/div[1]/div/div[1]/div/div/button/i',
        ),
        "labelling": Selector(By.XPATH, '//*[@id="labelling"]', type=ElementType.INPUT),
        "packaging educational": Selector(
            By.XPATH,
            '//*[@id="changes-to-product"]/div[2]/div/div[2]/div/div[1]/div/div/button/i',
        ),
        "packaging": Selector(By.XPATH, '//*[@id="packaging"]', type=ElementType.INPUT),
        "size educational": Selector(
            By.XPATH,
            '//*[@id="changes-to-product"]/div[2]/div/div[3]/div/div[1]/div/div/button/i',
        ),
        "size": Selector(By.XPATH, '//*[@id="size"]', type=ElementType.INPUT),
        ...
        "translations educational": Selector(
            By.XPATH,
            '//*[@id="changes-to-product"]/div[2]/div/div[5]/div/div[1]/div/div/button/i',
        ),
        ...
        "certificate of origin educational": Selector(
            By.XPATH,
            '//*[@id="documents-for-target-market"]/div/div/div[1]/div/div[1]/div/div/button/i'
        ...
        "insurance certificate educational": Selector(
            By.XPATH,
            '//*[@id="documents-for-target-market"]/div/div/div[2]/div/div[1]/div/div/button/i',
        ),
        ...
        "uk customs declaration educational": Selector(
            By.XPATH,
            '//*[@id="documents-for-target-market"]/div/div/div[4]/div/div[1]/div/div/button/i',
        ),
        ...
        "add another document": Selector(
            By.XPATH,
            "//body/main/div[2]/section[6]/div/div[2]/div/form/div[2]/div/button",
        ),
        "yes checkbox": Selector(By.CSS_SELECTOR, "#section-complete > div > label"),
        "marketing approach": Selector(
            By.XPATH,
            '//*[@id="adapting-your-product-content"]/section[7]/div/div/div[2]/a/span',
        ),
        ...
        "lesson": Selector(
            By.XPATH, '//*[@id="changes-to-product"]/div[1]/div[1]/button'
        ),
        "adapting your product or service": Selector(
            By.XPATH, '//*[@id="changes-to-product"]/div[1]/div[2]/a/div/h4'
        ),
    }
}
...
def enter_document_details(
    driver: WebDriver, position: str, document_name: str, notes: str
):
    # every call of this function, click on Add Goal
    find_and_click(driver, element_selector_name="Add another document")
    time.sleep(2)
    document_div_element_xpath = (
        "/html/body/main/div[2]/section[6]/div/div/div/form/div/div/div[5]/div"
        + "["
        + position
        + "]"
    )
...
def delete_all_document_details(driver: WebDriver, del_button_position: str):
    ...
    document_div_element_xpath = (
        "//body/main/div[2]/section[6]/div/div[2]/div/form/div[2]/div/div[5]/div"
        + "["
        + del_button_position
        + "]"
    )
