...
SELECTORS = {
    "target markets research": {
        ...
        "data snapshot": Selector(By.XPATH, '//*[@id="target-age-groups"]/div/button'),
        "select": Selector(
        ...
        "describe the consumer demand example": Selector(
            By.XPATH,
            "//body/main/div[2]/section[4]/div/div[2]/form/div[1]/div[2]/div[1]/button[1]",
        ),
        "describe the consumer demand": Selector(By.CSS_SELECTOR, "#demand"),
        ...
        "Who are your competitors": Selector(By.CSS_SELECTOR, "#competitors"),
        "What are the product trends example": Selector(
            By.XPATH, '//*[@id="target-markets-research"]/div[3]/div[2]/div[1]/button'
        ),
        "What are the product trends": Selector(By.CSS_SELECTOR, "#trend"),
        ...
        "using what you know": Selector(
            By.XPATH,
            "//h4[contains(text(),'Using what you know to help inform your positionin')]",
        ),
        "work out customer demand": Selector(
            By.XPATH,
            "//body/main/div[2]/section[4]/div/div[2]/form/div[1]/div[2]/div[2]/a/div/h4"
            # //h4[contains(text(),'Work out customer demand – how much might you sell')]"
        ),
        "work out customer demand lesson": Selector(
            By.XPATH,
            "//body/main/div[2]/section[4]/div/div[2]/form/div[1]/div[2]/div[1]/button[2]",
        ),
        ...
        "back": Selector(By.XPATH, "//body/div[8]/div/div/div/div[1]/a"),
        "add a target market": Selector(
            By.XPATH, "//button[contains(text(),'Add a target market')]"
        ),
        "search": Selector(By.CSS_SELECTOR, "#search-input", type=ElementType.INPUT),
        "top export plan home": Selector(
            By.XPATH,
            '//*[@id="target-markets-research-content"]/section[1]/div/div/div[2]/span/a',
        ),
...
def find_and_click_lesson_link(driver: WebDriver, lesson_name: str):
    ...
    for form_group_element in child_div_elements:
        learning_buttons_element = form_group_element.find_element_by_class_name(
            "learning"
        )
        button_element = learning_buttons_element.find_element_by_tag_name("button")
        button_element.click()
        time.sleep(2)
        learning_content_element = form_group_element.find_element_by_class_name(
            "learning__content"
        )
