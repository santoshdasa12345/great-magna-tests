...
SELECTORS = {
    "about your business": {
        ...
        "how you started example": Selector(
            By.CSS_SELECTOR,
            "#about-your-business-form > div:nth-child(1) > div > div.learning__buttons > button",
        ),
        ...
        "where you're based example": Selector(
            By.CSS_SELECTOR,
            "#about-your-business-form > div:nth-child(2) > div > div.learning__buttons > button",
        ),
        ...
        "how you make your products example": Selector(
            By.CSS_SELECTOR,
            "#about-your-business-form > div:nth-child(3) > div > div.learning__buttons > button",
        ),
        ...
        "your product packaging example": Selector(
            By.CSS_SELECTOR,
            "#about-your-business-form > div:nth-child(4) > div > div.learning__buttons > button",
        ),
        ...
        "your business performance label": Selector(
            By.CSS_SELECTOR,
            "#about-your-business-form > div.select.m-b-l > div > label",
        ),
...
def find_and_select_random_item_list(driver: WebDriver, element_selector_name: str):
    ...
    drop_down_element = driver.find_element_by_css_selector(
        "#about-your-business-form > div.select.m-b-l > div > div.select__placeholder.text-blue-deep-60.bg-white.radius > div.select__list.body-l.bg-white.radius.select__list--open"
    )  # about-your-business-form > div.select.m-b-l > div > div.select__placeholder.text-blue-deep-60.bg-white.radius > ul")
