...
SELECTORS = {
    "header": {
        ...
        "dit logo": Selector(
            By.ID, "body > header > div.atlas-header__global > div > img"
        ),
    },
    "home": {
    ...
    "sub heading": {
        ...
        "invest in the uk": Selector(
            By.CSS_SELECTOR, "#content > div.atlas-landing__hero"
        ),
    },
    "why invest in the uk": {
        "why invest in the section": Selector(
            By.CSS_SELECTOR, "#content > div:nth-child(4)"
        ),
        "reason": Selector(
            By.CSS_SELECTOR,
            "#content > div:nth-child(4) > div > div.atlas-grid.atlas-grid--masonry > div:nth-child(3) > a",
        ),
    },
    "uk sectors": {
    ...
    "investment opportunities": {
        "investment opportunities section": Selector(
    ...
    "how we can help": {
        "how we can help section": Selector(
            By.CSS_SELECTOR, "#content > div:nth-child(8)"
        ),
        "how we can help": Selector(
            By.CSS_SELECTOR,
            "#content > div:nth-child(8) > div > div.atlas-grid.atlas-grid--masonry > div:nth-child(3) > a",
        ),
    },
    "contact us": {
