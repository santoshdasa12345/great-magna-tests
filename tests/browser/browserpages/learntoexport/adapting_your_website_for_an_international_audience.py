...
NAME = "Adapting your website for an International audience"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = (
    URLs.GREAT_MAGNA_LESSONS_ADAPTING_YOUR_WEBSITE_FOR_AN_INTERNATIONAL_AUDIENCE.absolute
)
PAGE_TITLE = "Adapting your website for an International audience"

SELECTORS = {
    "adapting your website for an International audience": {
