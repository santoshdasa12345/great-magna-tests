...
NAME = "Customer demand vs ease of entry"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_CUSTOMER_DEMAND_VS_EASE_OF_ENTRY.absolute
PAGE_TITLE = "Customer demand vs ease of entry"
