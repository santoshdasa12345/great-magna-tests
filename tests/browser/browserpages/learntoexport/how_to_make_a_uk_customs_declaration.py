...
NAME = "How to make a uk customs declaaration"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_HOW_TO_MAKE_A_UK_CUSTOMS_DECLARATION.absolute
PAGE_TITLE = "How to make a uk customs declaaration"

SELECTORS = {
    "how to make a uk customs declaaration": {
