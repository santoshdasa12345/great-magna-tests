...
NAME = "Using samples prototypes and demos"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_USING_SAMPLES_PROTOTYPES_AND_DEMOS.absolute
PAGE_TITLE = "Using samples prototypes and demos"

SELECTORS = {
    "using samples prototypes and demos": {
