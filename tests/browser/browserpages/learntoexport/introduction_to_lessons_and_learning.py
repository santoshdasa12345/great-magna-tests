...
NAME = "Introduction to Lessons and Learning Page"
...
PAGE_TITLE = "Introduction to Lessons and Learning Page"

SELECTORS = {
    "introduction to lessons and learning": {
        "lesson complete": Selector(
        ...
        "top back": Selector(By.XPATH, "//body/main[@id='content']/div[1]/a[1]/i[1]"),
