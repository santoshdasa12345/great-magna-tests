...
NAME = "Choosing the right export opportunities"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_CHOOSING_THE_RIGHT_EXPORT_OPPORTUNITIES.absolute
PAGE_TITLE = "Choosing the right export opportunities"
