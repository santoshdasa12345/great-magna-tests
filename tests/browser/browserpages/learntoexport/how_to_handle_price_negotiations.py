...
NAME = "How to handle price negotiations"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_HOW_TO_HANDLE_PRICE_NEGOTIATIONS.absolute
PAGE_TITLE = "How to handle price negotiations"
