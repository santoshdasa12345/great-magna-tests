...
NAME = "Avoid cashflow challenges when exporting"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_AVOID_CASHFLOW_CHALLENGES_WHEN_EXPORTING.absolute
PAGE_TITLE = "Avoid cashflow challenges when exporting"

SELECTORS = {
    "avoid cashflow challenges when exporting": {
        "lesson yes checkbox": Selector(By.CSS_SELECTOR, "#markascomplete_checkbox"),
        ...
        "funding and credit": Selector(
            By.XPATH, "//body/main/div/div[1]/div/div[2]/div[3]/div/div"
        ),
    },
}
