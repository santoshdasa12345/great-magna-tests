...
NAME = "Understand data regulations and data protection"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_DATA_REGULATIONS_AND_DATA_PROTECTION.absolute
PAGE_TITLE = "Understand data regulations and data protection"
