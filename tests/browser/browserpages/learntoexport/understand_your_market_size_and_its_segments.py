...
NAME = "Understand your market size and its segments"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_YOUR_MARKET_SIZE_AND_ITS_SEGMENTS.absolute
PAGE_TITLE = "Understand your market size and its segments"

SELECTORS = {
    "understand your market size and its segments": {
