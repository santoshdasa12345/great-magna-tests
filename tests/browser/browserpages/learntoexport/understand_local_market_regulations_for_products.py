...
NAME = "Understand local market regulations for products"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_LOCAL_MARKET_REGULATIONS_FOR_PRODUCTS.absolute
PAGE_TITLE = "Understand local market regulations for products"

SELECTORS = {
    "understand local market regulations for products": {
