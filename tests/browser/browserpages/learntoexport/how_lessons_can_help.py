...
NAME = "How lessons can help"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_HOW_LESSONS_CAN_HELP.absolute
PAGE_TITLE = "How lessons can help"
...
SELECTORS = {
    "How lessons can help": {
        ...
        "bottom back": Selector(
            By.CSS_SELECTOR,
            "#content > div > div.bg-blue-deep-80 > div.container.p-v-s > a",
        ),
