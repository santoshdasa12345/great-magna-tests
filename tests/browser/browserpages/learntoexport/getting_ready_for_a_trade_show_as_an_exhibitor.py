...
NAME = "Getting ready for a trade show as an exhibitor"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_GETTING_READY_FOR_A_TRADE_SHOW_AS_AN_EXHIBITOR.absolute
PAGE_TITLE = "Getting ready for a trade show as an exhibitor"

SELECTORS = {
    "getting ready for a trade show as an exhibitor": {
