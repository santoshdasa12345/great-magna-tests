...
NAME = "Protect your data abroad"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_PROTECT_YOUR_DATA_ABROAD.absolute
PAGE_TITLE = "Protect your data abroad"

SELECTORS = {
    "protect your data abroad": {
