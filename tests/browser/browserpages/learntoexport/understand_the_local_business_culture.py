...
NAME = "Understand the local business culture"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_UNDERSTAND_THE_LOCAL_BUSINESS_CULTURE.absolute
PAGE_TITLE = "Understand the local business culture "
