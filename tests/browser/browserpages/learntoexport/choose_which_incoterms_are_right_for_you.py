...
NAME = "Choose which incoterms are right for you"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_CHOOSE_WHICH_INCOTERMS_ARE_RIGHT_FOR_YOU.absolute
PAGE_TITLE = "Choose which incoterms are right for you"
