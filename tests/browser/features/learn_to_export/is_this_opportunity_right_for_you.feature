...
# @allure.link:XOT-122
#   @Great-Magna-Lessons
# Scenario:User should be able to view Lesson pages for topic "Is this opportunity right for you" and click bottom back
#
#  Given "Robert" visited "GreatMagna - Login" page
#   When "Robert" decides to enter email address "santoshtesting10008+888@gmail.com", password "Testing@123!" and click Login
#    And "Robert" should be on the "GreatMagna - Dashboard" Page
...
#   And "Robert" decides to click on section "Bottom Back" on page "LearnToExport - Is this opportunity right for you"
#
#
#   @allure.link:XOT-123
#   @Great-Magna-Lessons
# Scenario:User should be able to view Lesson pages for topic "Is this opportunity right for you" and click top back
#
#  Given "Robert" visited "GreatMagna - Login" page
#   When "Robert" decides to enter email address "santoshtesting10008+888@gmail.com", password "Testing@123!" and click Login
#    And "Robert" should be on the "GreatMagna - Dashboard" Page
...
#    And "Robert" decides to click on section "Is this opportunity right for you" on page "LearnToExport - Identify opportunities"
#    And "Robert" decides to click checkbox Yes and click continue on "LearnToExport - Is this opportunity right for you"
#    And "Robert" decides to click on section "Top Back" on page "LearnToExport - Is this opportunity right for you"
#
# @allure.link:XOT-124
#   @Great-Magna-Lessons
# Scenario:User should be able to view Lesson pages for topic "Is this opportunity right for you" and click view all lessons
#
#  Given "Robert" visited "GreatMagna - Login" page
#   When "Robert" decides to enter email address "santoshtesting10008+888@gmail.com", password "Testing@123!" and click Login
#    And "Robert" should be on the "GreatMagna - Dashboard" Page
...
#   And "Robert" decides to click on section "Identify opportunities" on page "LearnToExport - Learn Categories"
#    And "Robert" decides to click on section "Is this opportunity right for you" on page "LearnToExport - Identify opportunities"
#    And "Robert" decides to click on section "view all lessons" on page "LearnToExport - Is this opportunity right for you"
#
