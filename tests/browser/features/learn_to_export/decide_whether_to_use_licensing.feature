...
#     And "Robert" decides to click on section "Decide whether to use licensing" on page "LearnToExport - Prepare to sell"
...
#   And "Robert" decides to click on section "Prepare to sell" on page "LearnToExport - Learn Categories"
#    And "Robert" decides to click on section "Decide whether to use licensing" on page "LearnToExport - Prepare to sell"
#    And "Robert" decides to click on section "view all lessons" on page "LearnToExport - Decide whether to use licensing"
