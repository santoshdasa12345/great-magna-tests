...
##     And "Robert" decides to click on "case study" on page "LearnToExport - Protect your business from bribery and corruption"
...
#   And "Robert" decides to click on section "Prepare to sell" on page "LearnToExport - Learn Categories"
#    And "Robert" decides to click on section "Protect your business from bribery and corruption" on page "LearnToExport - Prepare to sell"
#    And "Robert" decides to click on section "view all lessons" on page "LearnToExport - Protect your business from bribery and corruption"
