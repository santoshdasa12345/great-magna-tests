...
#     And "Robert" decides to click on section "How to set up a business abroad" on page "LearnToExport - Prepare to sell"
...
#   And "Robert" decides to click on section "Prepare to sell" on page "LearnToExport - Learn Categories"
#    And "Robert" decides to click on section "How to set up a business abroad" on page "LearnToExport - Prepare to sell"
#    And "Robert" decides to click on section "view all lessons" on page "LearnToExport - How to set up a business abroad"
