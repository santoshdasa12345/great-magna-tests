...
##     And "Robert" decides to click on "case study" on page "LearnToExport - How to prepare for a trade mission"
...
#   And "Robert" decides to click on section "Prepare to sell" on page "LearnToExport - Learn Categories"
#    And "Robert" decides to click on section "How to prepare for a trade mission" on page "LearnToExport - Prepare to sell"
#    And "Robert" decides to click on section "view all lessons" on page "LearnToExport - How to prepare for a trade mission"
