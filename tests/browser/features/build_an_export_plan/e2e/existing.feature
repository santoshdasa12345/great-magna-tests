...
#      fi
#      cp tests/chromedriver $HOME/bin
#      cd tests/browser
#
#
...
#      if [ -d "/home/circleci/great_magna_tests/tests/browser/reports" ]; then rm -Rf "/home/circleci/great_magna_tests/tests/browser/reports";
#      fi
#
