...
NAME = "Research current market conditions"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_RESEARCH_CURRENT_MARKET_CONDITIONS.absolute
PAGE_TITLE = "Research current market conditions"
