...
NAME = "Pitching and tendering in a new market"
SERVICE = Service.LEARNTOEXPORT
TYPE = PageType.LESSON
URL = URLs.GREAT_MAGNA_LESSONS_PITCHING_AND_TENDERING_IN_A_NEW_MARKET.absolute
PAGE_TITLE = "Pitching and tendering in a new market"

SELECTORS = {
    "Pitching and tendering in a new market": {
