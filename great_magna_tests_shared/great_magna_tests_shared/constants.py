...
MD5_CHECKSUM_GREAT_LOGO = env.str(
    "GREAT_LOGO_MD5_CHECKSUM", default="f99c4b6bb27330d6121500fb9682df41"
)
...
MD5_CHECKSUM_INVEST_IN_GREAT = env.str(
    "MD5_CHECKSUM_INVEST_IN_GREAT", default="f99c4b6bb27330d6121500fb9682df41"
)
MD5_CHECKSUM_DIT_FAVICON = env.str(
    "DIT_FAVICON_MD5_CHECKSUM", default="93bd34ac9de2cb059c65c5e7931667a2"
)
EMAIL_VERIFICATION_CODE_SUBJECT = "Your unique registration code"#"Your confirmation code for great.gov.uk"
